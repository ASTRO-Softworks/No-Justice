...
public class CharacterController2D : MonoBehaviour
{
    ...
    [SerializeField] private LayerMask m_WhatIsGround = LayerMask.NameToLayer("Default");                          // A mask determining what is ground to the character
    ...
    */
    ...
    public void Move(Vector2 moveDirection, Vector2 lookDirection)
    {
        ...
        //âûáèðàåì ñöåíàðèé ðàáîòû êîíòðîëëåðà
        switch (condition)
        {
    ...
    public void DinosaurMove(Vector2 tr, bool dirRight, bool crouch, bool jump, bool climbing, bool swimming)
    {
        ...
        if (!crouch)
        {
            ...
            Collider2D Col = Physics2D.OverlapCircle(transform.position + (Vector3)m_CeilingCheck, k_CeilingRadius, m_WhatIsGround);
