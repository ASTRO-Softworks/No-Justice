...
//        bulletSpeed = 1.0f;
    ...
    {
        float rotConst = transform.parent.parent.localScale.x > 0 ? 1 : -1;//(float)((((transform.rotation.eulerAngles.y / 180 - 1) * 2) + 1) * -1);
        /*
        ...
        */
        ...
        GameObject bull = Instantiate(bulletPrefab, firePoint.position, firePoint.rotation);
            ...
            bull.GetComponent<Rigidbody2D>().velocity = new Vector3(speed.x * bulletSpeed, speed.y * bulletSpeed * rotConst, 0);
